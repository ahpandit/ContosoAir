[![Build Status](https://dev.azure.com/ctrl-alt-sweets-training/ContosoAir/_apis/build/status%2Fahpandit.ContosoAir?branchName=master)](https://dev.azure.com/ctrl-alt-sweets-training/ContosoAir/_build/latest?definitionId=3&branchName=master)
